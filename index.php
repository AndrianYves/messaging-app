...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="index.php?id=1" class="brand-link">

      <span class="brand-text font-weight-light">Mario Felipe</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
              ...
              <div class="info">
                <a href='index.php?id=<?php echo $row['id']; ?>' class="d-block"><?php echo ucwords($row['name']);?></i></a>
              </div>
            </div>
          </li>
        <?php }?>
